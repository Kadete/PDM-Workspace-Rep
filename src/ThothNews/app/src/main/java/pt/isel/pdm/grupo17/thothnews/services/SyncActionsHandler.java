...
import static pt.isel.pdm.grupo17.thothnews.utils.TagUtils.TAG_MULTILIST_SEMESTERS_PREF_KEY;
...
public class SyncActionsHandler {
     ...
     * parameters.
     */
    void handleClassesUpdate(SyncResult syncResult) {
     ...
     * @param classID
     */
    SyncResult handleClassNewsUpdate(ArrayList<ContentProviderOperation> batch, SyncResult syncResult, InputStream stream, long classID) throws JSONException, IOException, ParseException {
