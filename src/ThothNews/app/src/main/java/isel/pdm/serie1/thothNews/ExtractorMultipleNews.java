...
import static isel.pdm.serie1.thothNews.Utils.SAVE_DATE_FORMAT;
import static isel.pdm.serie1.thothNews.Utils.readAllFrom;

/**
 * Created by Kadete on 28/10/2014.
 */
public class ExtractorMultipleNews extends AsyncTask<String, Void, ArrayList<ThothClassNewListItem>> {
